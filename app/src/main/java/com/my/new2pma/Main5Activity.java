...
String ed_id=""+i;
                    ...
                    SQLiteDatabase db = db1.getWritableDatabase();
                    //Toast.makeText(this,"this "+c1,LENGTH_SHORT).show();
...
next3();
    ...
    {
        try{
        Intent newact=new Intent(this,first.class);
        newact.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(newact);}
        catch(Exception e) {
            Toast.makeText(Main5Activity.this,e+ "return home error", Toast.LENGTH_SHORT).show();
        }
    }
}
